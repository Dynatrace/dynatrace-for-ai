...
- Use the Dynatrace MCP server tools for live data access when available

## Workflow

1. Understand the user's observability question
2. Load the relevant Dynatrace skill(s) for domain knowledge
3. If MCP tools are available, use them to query live data
...
- When MCP tools are not available, provide DQL query examples the user can run manually
