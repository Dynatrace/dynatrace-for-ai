...
- **[Dynatrace MCP server](https://www.dynatrace.com/hub/detail/dynatrace-mcp-server/)** — Official MCP server for Dynatrace API access. Use this if your agent supports MCP natively.
